...
\begin{frame}
  ...
  \begin{alertblock}{Economic Interpretation}
    ...
    Generalizes the standard transversality condition $\beta R < 1$
  \end{alertblock}
\end{frame}
...
\begin{frame}
  ...
  \begin{alertblock}{Key Insight (generalized from Theorem 3.1)}
...
\begin{frame}
  ...
  \begin{alertblock}{Theoretical Dichotomy}
    \begin{itemize}
